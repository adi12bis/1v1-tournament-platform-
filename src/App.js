...
const Hi = React.lazy(() => import("./components/Hi"));
const Navigatebutton = React.lazy(() => import("./components/Navigatebutton"));
      ...
      <Router>
        <Suspense fallback={<Loading />}>
          ...
          <Routes>
            ...
            <Route path="/home1" element={<Hi />} />
            <Route path="/home" element={<Home />} />
            <Route path="/go-home" element={<Navigatebutton />} />
